...
class App extends Component {
    render() {
        return ( <
            ...
            <
            p class = "h4 mb-4 text-left" > Login to
            continue < /p>
            ...
            type = "submit"
            style = "background-image: url(https://i.imgur.com/6YuRxJA.png)" > LOGIN < /button> <
            button class = "btn btn-info btn-block my"
            ...
            <
            div class = "col-sm-8 xyz text-center"
            ...
            button class = "btn btn-info btn-block sign"
